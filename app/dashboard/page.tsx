...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-charcoal">
<NavBar variant="dashboard" back={{ href: '/', label: 'Back to app' }} />
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="relative bg-white text-charcoal px-4 py-2.5 rounded-full text-sm font-semibold border-2 border-gold/50 hover:bg-gold/10 hover:border-gold transition-colors min-h-[44px]"
                    >
                      {copied ? '✓ Copied!' : '📋 Copy Shop Link'}
                    </button>
                    <a
                      href={`https://wa.me/?text=${encodeURIComponent(`Check out my full catalog and prices on Campus Plug: https://campuspluggh.com/shop/${userId} 🛍️`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 bg-white text-charcoal px-4 py-2.5 rounded-full text-sm font-semibold border-2 border-gold/50 hover:bg-gold/10 hover:border-gold transition-colors min-h-[44px]"
                    >
                      ...
                      Share Shop to WhatsApp Status
                    </a>
                  </div>
                  <p className="text-[11px] text-gray-500 sm:text-right max-w-sm">
                    Paste your shop link in your WhatsApp About, Status, or Instagram bio so customers can browse your full catalog.
                  </p>
                </div>
              </div>
            </div>

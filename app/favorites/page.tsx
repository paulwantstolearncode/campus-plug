          ...
          {listings.length === 0 ? (
            ...
            <div className="relative overflow-hidden bg-white rounded-3xl p-12 md:p-20 text-center border border-gray-100 shadow-xl max-w-2xl mx-auto">
              <div className="relative">
                ...
                <h2 className="font-serif-accent text-2xl md:text-3xl text-charcoal mb-3">Your plug list is empty, chale.</h2>
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                  Save items you like while browsing so you can find them later.
                </p>
                <Link
                  href="/services"
